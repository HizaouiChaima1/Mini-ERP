...
export const stockAPI = {
    ...
    createProduct: (data: unknown) => apiClient.post('/stock/produits', data),
    updateProduct: (id: number, data: unknown) => apiClient.put(`/stock/produits/${id}`, data),
...
export const salesAPI = {
    ...
    createOrder: (data: unknown) => apiClient.post('/ventes/commandes', data),
...
export const financeAPI = {
    ...
    recordPayment: (id: number, data: unknown) => apiClient.post(`/finance/factures/${id}/paiements`, data),
